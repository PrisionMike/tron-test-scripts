...
async function main() {
  ...
  const outFile = args.out || 'claim_tx.json';
  ...
  console.log(`Contract:   WithdrawExpireUnfreezeContract`);
  ...
  unsignedTx = await tronWeb.transactionBuilder.withdrawExpireUnfreeze(ownerAddress);
